// Monochromatic SVG icons — single stroke color, retro line style
const icons = {
  video: (
    <svg width="28" height="28" viewBox="0 0 28 28" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
      <rect x="2" y="6" width="17" height="16" rx="1.5" />
      <polyline points="19,10 26,7 26,21 19,18" />
  ...
  live: (
    <svg width="28" height="28" viewBox="0 0 28 28" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M6 6a11.3 11.3 0 0 0 0 16" />
      <path d="M22 6a11.3 11.3 0 0 1 0 16" />
      <path d="M9 9a7 7 0 0 0 0 10" />
      <path d="M19 9a7 7 0 0 1 0 10" />
    </svg>
  ),
  pipeline: (
    <svg width="28" height="28" viewBox="0 0 28 28" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
      ...
      <rect x="20" y="10" width="6" height="8" rx="1" />
      <line x1="8" y1="14" x2="11" y2="10" />
      <line x1="17" y1="10" x2="20" y2="14" />
    </svg>
  ),
  ai: (
    <svg width="28" height="28" viewBox="0 0 28 28" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
      ...
      <line x1="5.5" y1="5.5" x2="9.8" y2="9.8" />
      <line x1="18.2" y1="18.2" x2="22.5" y2="22.5" />
      <line x1="22.5" y1="5.5" x2="18.2" y2="9.8" />
      <line x1="9.8" y1="18.2" x2="5.5" y2="22.5" />
    </svg>
  ),
  brand: (
    <svg width="28" height="28" viewBox="0 0 28 28" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
  ...
  consulting: (
    <svg width="28" height="28" viewBox="0 0 28 28" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
      <path d="M4 20V8a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v12" />
  ...
  post: (
    <svg width="28" height="28" viewBox="0 0 28 28" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
      ...
      <polyline points="8,12 12,16 16,11 20,15" />
...
function ServiceCard({ service }) {
  return (
    ...
    >
      <div style={{ fontFamily: "'Space Mono', monospace", fontSize: '0.62rem', color: 'rgba(181,97,74,0.5)', letterSpacing: '0.14em', marginBottom: '1.2rem' }}>
        {service.num}
      </div>
      <div style={{ color: 'var(--mid-brown)', marginBottom: '1rem' }}>
        {icons[service.icon]}
      </div>
      <div style={{ fontSize: '1rem', fontWeight: 600, marginBottom: '0.75rem', letterSpacing: '-0.01em' }}>
        {service.title}
      </div>
      <p style={{ fontSize: '0.86rem', color: 'var(--muted-brown)', lineHeight: 1.72 }}>
        {service.desc}
      </p>
    </div>
  )
...
export default function Services() {
  return (
    <section id="services" style={{ background: 'var(--warm-white)', padding: '7rem 3rem' }}>
      <div style={{ maxWidth: 1200, margin: '0 auto 3.5rem' }}>
        <div className="section-label">What We Do</div>
        <h2 className="section-title">Full-Spectrum<br />Production &amp; Consulting</h2>
