...
// Monochromatic SVG icons — single stroke, retro line style
const icons = {
  video: (
    ...
    >
      ...
      <motion.div
        style={{
          ...
          bottom: 0, right: 0,
          width: 40, height: 40,
          background: 'linear-gradient(135deg, transparent 50%, rgba(181,97,74,0.07) 50%)',
        }}
      />
      <div style={{ fontFamily: "'Space Mono', monospace", fontSize: '0.6rem', color: 'rgba(181,97,74,0.45)', letterSpacing: '0.14em', marginBottom: '1.1rem' }}>
        {service.num}
      </div>
